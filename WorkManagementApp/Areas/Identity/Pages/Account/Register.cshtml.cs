...
namespace WorkManagementApp.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        {
            if(!_roleManager.RoleExistsAsync(SD.Role_user_Local).GetAwaiter().GetResult())
            {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        await _userManager.AddToRoleAsync(user, SD.Role_user_Local);
                    }
